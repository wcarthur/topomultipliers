...
for j in range(1, nc - 1):
    data_row[nr - 1, j] = (data[nr - 1, j - 1] + data[nr - 1, j] + \
            data[nr - 1, j + 1])/3.
  
data_row[nr - 1, nc - 1] = (data[nr - 1, nc - 2] + data[nr - 1, nc - 1] +\
            data[nr - 2, nc - 1])/3.
